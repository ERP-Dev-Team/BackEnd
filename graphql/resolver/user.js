        ...
        userUpdated = await User.findOneAndUpdate(
          { _id: args._id },
          {
            $set: {
              ...
              joiningPlace: args.joiningPlace,
              joiningDate: args.joiningDate,
              dateOfBirth: args.dateOfBirth,
              qualification: args.qualification,
              salary: args.salary,
              batta: args.batta,
              salaryEffectiveDate: args.salaryEffectiveDate,
              salaryOld: args.salaryOld,
              battaOld: args.battaOld,
              loginAllowed: args.loginAllowed,
              refPerson: args.refPerson,
              refPersonPhone: args.refPersonPhone,
              refPersonAddress: args.refPersonAddress,
              IMEIAllowed: args.IMEIAllowed,
              bankAccountNumber: args.bankAccountNumber,
              bankName: args.bankName,
              bankBranchName: args.bankBranchName,
              bankBranchCity: args.bankBranchCity,
              bankIIFSCCode: args.bankIIFSCCode,
              bankAccountHolderName: args.bankAccountHolderName,
              designation: args.designation,
              rolesAllowed: args.rolesAllowed,
              modulesAllowed: args.modulesAllowed,
              campAllowed: args.campsAllowed,
            },
          },
